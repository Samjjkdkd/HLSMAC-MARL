        ...
        while True:
            ...
            for idx, parent_conn in enumerate(self.parent_conns):
                if not terminated[idx]:
                    ...
                    # print(data["reward"]) reward, delta_enemy, delta_deaths, delta_ally
                    # print(type(data["reward"]))
                    # Unpack reward tuple (same as in episode_runner.py)
                    reward_value = data["reward"][0] if isinstance(data["reward"], tuple) else data["reward"]
                    post_transition_data["reward"].append((reward_value,))

                    episode_returns[idx] += reward_value
